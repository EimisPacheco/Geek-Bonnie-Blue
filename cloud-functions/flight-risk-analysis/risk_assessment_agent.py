        ...
        try:
            ...
            if num_connections == 0:
                ...
                for i, connection in enumerate(connections):
                    ...
                    print(f"🔗 DURATION PENALTY: {base_duration_penalty} × {duration_multiplier}x = {duration_penalty:.1f} for {layover_airport}")
                    ...
                    # 3. ENHANCED: Airport-specific missed connection penalties
                    missed_connection_penalty = 0
                    
                    # ENHANCED: More granular airport-specific minimums
                    if layover_airport in ['ATL', 'ORD', 'DFW']:  # World's busiest hubs
