                      ...
                      return (
                        ...
                        <div className="flex-1">
                          <div className="text-base mb-1">
                            ...
                            <button
                              onClick={() => {
                                const airportCode = connectionData.layoverInfo?.airport || connectionData.arrival.airport.code;
                                console.log('🗺️ Location button clicked for layover airport:', airportCode);
                                setSelectedAirport({
                                  code: airportCode,
                                  name: connectionData.layoverInfo?.airport_name || connectionData.arrival.airport.name,
                                  city: connectionData.layoverInfo?.city || connectionData.arrival.airport.city,
                              ...
                              className={`flex-shrink-0 p-2 rounded-lg transition-colors flex items-center space-x-1 ${
                                isDarkMode 
                                  ? 'bg-orange-900/50 hover:bg-orange-800/50 text-orange-200' 
                            ...
                            >
                              ...
                              <span className="text-xs font-medium">
                                <TranslatedText text="View" targetLanguage={currentLanguage} />
                              </span>
                            </button>
                      </div>
                    </div>
