  ...
  return (
    <div className={`min-h-screen p-6 ${isDarkMode ? 'bg-slate-900 text-white' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <div className={`mb-8 p-6 rounded-2xl border transition-all duration-300 ${
        ...
        <div className="mb-6">
          <div className={`inline-flex items-center space-x-3 px-4 py-3 rounded-lg backdrop-blur-sm border ${
            isDarkMode 
            ...
            <div className="flex-1">
              <p className="text-sm font-medium">
                <TranslatedText text="Want instant analysis while browsing Google Flights?" targetLanguage={currentLanguage} />
              </p>
            </div>
            <a 
              ...
              className={`flex items-center space-x-2 px-3 py-1.5 rounded-lg font-medium transition-all text-sm ${
                isDarkMode 
